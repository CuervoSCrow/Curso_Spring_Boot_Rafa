package com.laboratorio.springboot17.controller;

import com.laboratorio.springboot17.model.Producto;
import com.laboratorio.springboot17.service.ProductoService;
import com.laboratorio.springboot17.util.exception.InvalidDataException;
...
public class ProductoRestController {
    ...
    public ResponseEntity<?> update(@PathVariable Integer id,
        ...
        try {
            Optional<Producto> productoModificar = this.productoService.findById(id);
